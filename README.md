...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/constants-float32-significand-mask/tags). For example,

```javascript
FLOAT32_SIGNIFICAND_MASK = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-significand-mask@v0.1.0-umd/browser.js' )
```
